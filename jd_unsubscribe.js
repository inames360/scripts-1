...
let goodPageSize = $.getdata('jdUnsubscribePageSize') || 80;// 运行一次取消多全部已关注的商品。数字0表示不取关任何商品
let shopPageSize = $.getdata('jdUnsubscribeShopPageSize') || 80;// 运行一次取消全部已关注的店铺。数字0表示不取关任何店铺
